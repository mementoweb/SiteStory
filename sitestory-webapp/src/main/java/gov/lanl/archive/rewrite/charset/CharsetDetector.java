...
import gov.lanl.archive.rewrite.TagParser;
...
//  <meta http-equiv="Content-type" content="text/html; charset=i so-8859-1">
	...
	protected String getCharsetFromMeta(InputStream resource) throws IOException {
		...
		String metaContentType = TagParser.getTagAttrWhere(sb, "META",
	 ...
	 */
	public abstract String getCharset(InputStream resource, String ctype)
		throws IOException;
}
